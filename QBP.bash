...
default_app_name='MyQtWidgetsApplication'
default_app_description='My Qt Widgets Application'
default_app_version='0.0.1'
default_app_copyright='Copyright (C) 2016  John Doe'
default_target_name='myqtwidgetsapplication'
...
do
  ...
  echo "${output_prompt} Application: '${app_name}'"
  ...
  case "${is_ok}" in
    [yY] | [yY][eE][sS] )
      echo "${output_prompt} Okay, generating application template..."

      creation_time=$(date --iso-8601='seconds')

      cp -Riv './QtWidgetsApplication/' "./${app_name}/"
      ...
      rm -iv './QtWidgetsApplication.pro.user'
      # mv -iv './QtWidgetsApplication.pro.user' "./${app_name}.pro.user"

      mv -iv './QtWidgetsApplication.pro' "./${app_name}.pro"
